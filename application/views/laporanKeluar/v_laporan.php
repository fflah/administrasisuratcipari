                ...
                <td style="padding-bottom: 20px;" colspan="2">                    
                    <table class="tabel-surat" style=" margin-left: auto; margin-right: auto; margin-top: 30px;" border="1" width="95%">
                        ...
                        <tr>
                            <th scope="row"><?= $i;?></th>
                            <td><?= $data->no_surat?></td>
                            <td><?= $data_surat['tanggal'] = tanggal_indo(date('Y-n-d', strtotime($data->tanggal)));  ?></td>
...
<script>
    window.onload = function () { 
        ...
        if (path[2] == 'laporankeluar') {
                window.onafterprint = function(){
                console.log("Printing completed...");
                location.replace("<?= base_url('laporanKeluar')?>")
            } 
        }else{
            window.onafterprint = function(){
                console.log("Printing completed...");
