...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <link href="<?php echo base_url()?>/assets/print_assets/surat_nikah/base.min.css" rel="stylesheet">
        <link href="<?php echo base_url()?>/assets/print_assets/surat_nikah/fancy.min.css" rel="stylesheet">
        <link href="<?php echo base_url()?>/assets/print_assets/surat_nikah/main.css" rel="stylesheet">

        <script src="<?php echo base_url()?>/assets/print_assets/surat_nikah/compatibility.min.js"></script>
        <script src="<?php echo base_url()?>/assets/print_assets/surat_nikah/theViewer.min.js"></script>
        <script>
            try{
        ...
        <title>Surat Keterangan Nikah</title>
    </head>
    <body>
      <div id="sidebar">
         <div id="outline"></div>
      ...
      <div id="page-container">
         <div id="pf1" class="pf w0 h0" data-page-no="1">
            <div class="pc pc1 w0 h0">
               <img class="bi x0 y0 w0 h0" alt="" src="<?php echo base_url()?>assets/print_assets/surat_nikah/bg1.png">
               ...
               <div class="t m0 x7 h4 y7 ff1 fs2 fc0 sc0 ls0 ws0">SURAT KETERANGAN NIKAH</div>
               ...
               <div class="t m0 x9 h5 y12 ff2 fs2 fc0 sc0 ls0 ws0">Telah <span class="_ _8"> </span>mendapatkan <span class="_ _8"> </span>izin <span class="_ _8"> </span>untuk <span class="_ _8"> </span>melangsungkan <span class="_ _8"> </span>pernikahan <span class="_ _8"> </span>sebagai <span class="_ _8"> </span>persyaratan <span class="_ _8"> </span>untuk </div>
               <div class="t m0 x9 h5 y13 ff2 fs2 fc0 sc0 ls0 ws0">mendaftarkan data pernikahan ke Kantor Urusan Agama (KUA).</div>
               ...
               <div class="t m0 xb h5 y16 ff2 fs2 fc0 sc0 ls0 ws0">          <span class="_ _a"> </span>Gandrungmangu,   <?=$data_surat['tanggal']?></div>
               <div class="t m0 x9 h5 y17 ff2 fs2 fc0 sc0 ls0 ws0">             <span class="_ _b"> </span><span class="fs1">                                     </span></div>
               <div class="t m0 xc h5 y18 ff2 fs2 fc0 sc0 ls0 ws0">       <span class="_ _c"> </span>     <?=$jabatan_ttd?></div>
               <div class="t m0 xd h5 y19 ff2 fs2 fc0 sc0 ls0 ws0">   </div>
               <div class="t m0 xd h4 y1a ff1 fs2 fc0 sc0 ls0 ws0">         <span class="_ _d"> </span>    <?=$nama_ttd?></div>
            </div>
