                ...
                <p class="lead">Silahkan lengkapi semua isian sesuai dengan data yang diperlukan</p>
                    ...
                    <div class="controls">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-10">
                                <div class="form-group">
                                    <label for="form_wa">Jenis Surat</label>
                                     <input type="text" width="50%" name="jenis_surat" class="form-control" value="Surat Kematian" readonly required >  
                                    <div class="help-block with-errors"></div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-10">
                                <div class="form-group">
                                    <label for="form_wa">Hari Meninggal</label>
                                    <input id="form_wa" type="text" name="hari_meninggal" class="form-control" placeholder="Silahkan masukkan hari meninggal *" required="required" data-error="Format no salah.">
                                </div>
                            </div>

                            <div class="col-md-10">
                                <div class="form-group">
                                    <label for="form_wa">Jam Meninggal</label>
                                    <input id="form_wa" type="text" name="jam_meninggal" class="form-control" placeholder="Silahkan masukkan jam meninggal *" required="required" data-error="Format no salah.">
                                </div>
                            </div>
