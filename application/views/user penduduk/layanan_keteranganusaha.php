                ...
                <p class="lead">Silahkan lengkapi semua isian sesuai dengan data yang diperlukan</p>
                    ...
                    <div class="controls">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-10">
                                <div class="form-group">
                                    <label for="form_wa">Jenis Surat</label>
                                     <input type="text" width="50%" name="jenis_surat" class="form-control" value="Surat Keterangan Usaha" readonly required >  
                                    <div class="help-block with-errors"></div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-10">
                                <div class="form-group">
                                    <label for="form_wa">Nama Usaha</label>
                                     <input type="text" width="50%" name="nama_usaha" placeholder="Silahkan masukkan nama usaha anda *" class="form-control" required >  
                                    <div class="help-block with-errors"></div>
                                </div>
                            </div>
