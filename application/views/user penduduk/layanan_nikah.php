                        ...
                        <div class="row">
                            ...
                            <div class="col-md-10">
                                <div class="form-group">
                                    <label for="form_wa">Jenis Surat</label>
                                     <input type="text" width="50%" name="jenis_surat" class="form-control" value="Surat Nikah" readonly required >  
                                    <div class="help-block with-errors"></div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-10">
                                <div class="form-group">
                                    ...
                                    <div class="custom-file">
                                        <input required name="akta_kelahiran" type="file" class="custom-file-input" id="akta_kelahiran">
                            ...
                            <div class="col-md-10">
                                <div class="form-group">
                                    ...
                                    <div class="custom-file">
                                        <input required name="ijazah" type="file" class="custom-file-input" id="ijazah">
                                        <label class="custom-file-label" for="ktp">Choose file</label>
                                    </div>
                                    <SMALL> 
                                     Upload dalam file .png, .jpg, .pdf, .doc maksimal 3MB
...
<script>
    ...
    $('#akta_kelahiran').on('change',function(){
        //get the file name
        var fileName = $(this).val();
        text = fileName.substring(fileName.lastIndexOf("\\") + 1, fileName.length);
        $(this).next('.custom-file-label').html(text);
