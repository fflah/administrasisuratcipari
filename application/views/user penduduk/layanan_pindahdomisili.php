                ...
                <p class="lead">Silahkan lengkapi semua isian sesuai dengan data yang diperlukan</p>
                    ...
                    <div class="controls">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-10">
                                <div class="form-group">
                                    <label for="form_wa">Jenis Surat</label>
                                     <input type="text" width="50%" name="jenis_surat" class="form-control" value="Surat Pindah Daerah" readonly required >  
                                    <div class="help-block with-errors"></div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-10">
                                <div class="form-group">
                                    <label for="form_wa">Alamat	 Pindah</label>
                                    <input id="form_wa" type="text" name="alamat_pindah" class="form-control" placeholder="Silahkan masukkan alamat pindah anda *" required="required" data-error="Format no salah.">
                                </div>
                            </div>
                            
                            <div class="col-md-10">
                                <div class="form-group">
                                    <label for="form_wa">Alasan Pindah</label>
                                    <input id="form_wa" type="text" name="alasan_pindah" class="form-control" placeholder="Silahkan masukkan alasan pindah anda *" required="required" data-error="Format no salah.">
                                </div>
                            </div>
                            
                            <div class="col-md-10">
                                <div class="form-group">
                                    <label for="form_wa">Pengikut</label>
                                    <input id="form_wa" type="text" name="pengikut" class="form-control" placeholder="Silahkan masukkan jumlah pengikut anda *" required="required" data-error="Format no salah.">
                                </div>
                            </div>                                                        
                            ...
                            <div class="col-md-10">
                             ...
                             <div class="col-md-10">
                                <div class="form-group">
                                    <label>E-KTP *</label>
                                    <div class="custom-file">
                                        <input required name="ktp" type="file" class="custom-file-input" id="ktp">
